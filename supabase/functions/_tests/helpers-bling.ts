/**
 * Utilitários de teste — só Bling (fetch mockado, config de teste,
 * logger silencioso). Deliberadamente SEM nada de InfinitePay (ver
 * helpers.ts para isso) — usado pelos testes da feature de produtos/
 * estoque, que precisam ficar isolados de qualquer dado da conta
 * InfinitePay (ex.: handle real) ao serem publicados/commitados.
 */
import type { BlingConfig } from '../_shared/config.ts';
